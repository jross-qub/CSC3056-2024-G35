...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		// 1-Setup phase
		double balanceBefore = SimpleBankingApp.getBalance("5495-1291"); 
		double withdrawAmount = 94.86;
		
		// 2-Exercise phase
		SimpleBankingApp.addTransaction("5495-1291", -withdrawAmount);
		double balanceAfter = SimpleBankingApp.getBalance("5495-1291");
